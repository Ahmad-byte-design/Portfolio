        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`
                  w-1/2 p-4 rounded-xl shadow-md bg-muted-foreground border border-primary -mx-5
              ...
              <div className="absolute left-1/2 w-3 h-3 bg-yellow-400 rounded-full -translate-x-1/2" />
            </motion.div>
          );
        })}
      </div>
